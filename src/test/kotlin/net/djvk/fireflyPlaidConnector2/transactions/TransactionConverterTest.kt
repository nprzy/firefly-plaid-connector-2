...
//                    expectedDestinationName: String?,
        ...
        fun provideDescriptionCases(): List<Arguments> {
            return listOf(
                ...
                Arguments.of(
                    "when description is redundant, redundantDescription can be used to omit redundant info",
                    TransactionStyleConfig(
                        "#redundantDescription ? originalDescription : #merchantNameWithFallback + ': ' + originalDescription"
                    ),
                    "unused", // Plaid "name"
                    "Contoso", // Plaid "merchantName"
                    "Contoso", // Plaid "originalDescription"
                    "Contoso", // Expected FF description
                ),
                Arguments.of(
                    "when description is not redundant, usage of redundantDescription does not omit redundant info",
                    TransactionStyleConfig(
                        "#redundantDescription ? originalDescription : #merchantNameWithFallback + ': ' + originalDescription"
                    ),
                    "unused", // Plaid "name"
                    "Contoso", // Plaid "merchantName"
                    "Desc", // Plaid "originalDescription"
                    "Contoso: Desc", // Expected FF description
                ),
                Arguments.of(
